...
<div class="disclaimer-ribbon">
  <div class="he">
    ⚠️ <strong>אזהרה:</strong> אינני יועץ פיננסי ואינני יועץ השקעות. אין כאן ייעוץ ואין כאן המלצה.
    התוכן <strong>חינוכי בלבד</strong>. כל פעולה שתבצעו בכספכם היא באחריותכם הבלעדית.
  </div>
  <div class="en">
...
<div class="disclaimer-footer">
  <div class="he">
    ...
    הם אינם מהווים ייעוץ, אינם בגדר המלצה, ואינם מתחשבים במצבכם הפיננסי האישי.
    מסחר במט"ח או בארביטראז' כרוך בסיכון משמעותי לאובדן הון, ולעיתים אף בהפסד הגדול מההון שהושקע.
    ביצועי עבר אינם מבטיחים ביצועי עתיד. כל הסתמכות על תוכן כלשהו כאן היא באחריותכם הבלעדית.
    מומלץ להתייעץ עם בעל רישיון מתאים לפני כל פעולה פיננסית.
  </div>
  <div class="en">
